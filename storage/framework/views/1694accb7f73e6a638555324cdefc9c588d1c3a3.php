...
<div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo e(route('admin-shipping.store')); ?>">
      <?php elseif(Auth::check() && Auth::user()->role->id == 2): ?>
      <form method="post" action="<?php echo e(route('manager-shipping.store')); ?>">
      <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\NL\Documents\Applications\isure\resources\views/backend/shipping/create.blade.php ENDPATH**/ ?>
...
<div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo e(route('manager-category.store')); ?>">
      <?php endif; ?>
        ...
        <div class="form-group d-none" id='child_parent_cat_div'>
          ...
          <select name="parent_id" class="form-control">
              ...
              <?php $__currentLoopData = $child_parent_cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$child_parent_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($child_parent_cat->is_parent === 0): ?>
                  <option value='<?php echo e($child_parent_cat->id); ?>'><?php echo e($child_parent_cat->title); ?></option>
                <?php endif; ?>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\NL\Documents\Applications\isure\resources\views/backend/category/create.blade.php ENDPATH**/ ?>
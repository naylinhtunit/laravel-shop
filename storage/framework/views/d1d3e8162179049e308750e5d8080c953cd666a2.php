...
<div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo e(route('admin-brand.update',$brand->id)); ?>">
      <?php elseif(Auth::check() && Auth::user()->role->id == 2): ?>
      <form method="post" action="<?php echo e(route('manager-brand.update',$brand->id)); ?>">
      <?php endif; ?>
        <?php echo csrf_field(); ?> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\NL\Documents\Applications\isure\resources\views/backend/brand/edit.blade.php ENDPATH**/ ?>
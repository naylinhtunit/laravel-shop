    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <?php elseif(Auth::check() && Auth::user()->role->id == 2): ?>
            <a class="collapse-item" href="<?php echo e(url('manager/banner')); ?>">Banners</a>
            <a class="collapse-item" href="<?php echo e(url('manager/banner/create')); ?>">Add Banners</a>
          <?php endif; ?>
        </div>
      </div>
    </li>
...
</ul><?php /**PATH C:\Users\NL\Documents\Applications\isure\resources\views\manager\layouts\sidebar.blade.php ENDPATH**/ ?>
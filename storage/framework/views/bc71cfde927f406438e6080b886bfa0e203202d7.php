      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>&copy; <a href="/" target="_blank">Isure</a> <?php echo e(date('Y')); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <script src="<?php echo e(asset('backend/js/dashboard.min.js')); ?>"></script>
  ...
  </script><?php /**PATH C:\Users\NL\Documents\Applications\laravel-shop\resources\views/backend/layouts/footer.blade.php ENDPATH**/ ?>
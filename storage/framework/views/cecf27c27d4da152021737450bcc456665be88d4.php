...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="facebook" required value="<?php echo e($data->facebook); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="instagram" required value="<?php echo e($data->instagram); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="youtube" required value="<?php echo e($data->youtube); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="twitter" required value="<?php echo e($data->twitter); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\NL\Documents\Applications\isure\resources\views\user\setting.blade.php ENDPATH**/ ?>
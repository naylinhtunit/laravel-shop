    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        <tr>
            ...
            <td><?php $__currentLoopData = $shipping_charge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> MMK <?php echo e(number_format($data,2)); ?> MMK <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
              ...
              <table class="table">
                    ...
                    <tr>
                      ...
                      ?>
                        ...
                        <td> : <?php echo e(number_format($shipping_charge[0],2)); ?> MMK</td>
                    </tr>
                    <tr>
                      <td>Coupon</td>
                      <td> : <?php echo e(number_format($order->coupon,2)); ?> MMK</td>
                    </tr>
                    <tr>
                        <td>Total Amount</td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('manager.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\NL\Documents\Applications\isure\resources\views\manager\order\show.blade.php ENDPATH**/ ?>
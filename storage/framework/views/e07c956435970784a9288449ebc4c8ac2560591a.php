...
<?php $__env->startSection('title','Isure || Banner Create'); ?>
...
<div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo e(route('admin-banner.store')); ?>">
      <?php elseif(Auth::check() && Auth::user()->role->id == 2): ?>
      <form method="post" action="<?php echo e(route('manager-banner.store')); ?>">
      <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
        <label for="inputPhoto" class="col-form-label">Photo dimension size 1200px * 560px<span class="text-danger">*</span></label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\NL\Documents\Applications\isure\resources\views/backend/banner/create.blade.php ENDPATH**/ ?>
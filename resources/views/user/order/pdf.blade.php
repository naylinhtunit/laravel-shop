    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>{{number_format($cart->price,2)}} MMK</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>{{number_format($order->sub_total,2)}} MMK</span></th>
        </tr>
      ...
      @endif --}}
        <tr>
          ...
          <th><span>{{number_format($order->delivery_charge,2)}} MMK</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>

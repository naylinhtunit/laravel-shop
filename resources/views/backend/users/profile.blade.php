...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         ...
         <li><a href="{{route('manager')}}" style="color:#999">Dashboard</a></li>
         @endif
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body mt-4 ml-2">
                      ...
                      <p class="card-text text-left"><small class="text-muted"><i class="fas fa-hammer"></i> {{$profile->role->name}}</small></p>
                    </div>
                  </div>
            </div>
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputTitle" type="text" name="username" placeholder="Enter username"  value="{{$profile->username}}" class="form-control">
                        @error('username')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>

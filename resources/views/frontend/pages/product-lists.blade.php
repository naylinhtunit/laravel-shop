...
@section('title','Laravel-Shop || PRODUCT PAGE')
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">{{number_format($product->price,2)}} MMK</del>   {{number_format($org,2)}} MMK  </p>                                                
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    @endforeach
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	<a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}"><i class="fa fa-shopping-basket"></i><span>Add to cart</span></a>
													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
																...
																<del>{{number_format($product->price,2)}} MMK</del>
															</div>
															<h3 class="title"><a href="{{route('product-detail',$product->slug)}}">{{$product->title}}</a></h3>
														</div>
														<p class="des pt-2">{!! html_entity_decode($product->summary) !!}</p>
														<a class="btn cart" href="{{route('add-to-cart',$product->slug)}}">Buy Now!</a>
													</div>
												</div>
											</div>
										</div>
